...
module.exports.run = async (bot, message, args) =>
{
    ...
    await szMessagePing.edit(`<:cookiemonsta:634866060465537034> **|** :ping_pong: Latency is **${szMessagePing.createdTimestamp - message.createdTimestamp}ms**. API Latency is **${Math.round(bot.ws.ping)}ms**`);
};
