...
module.exports.run = async (bot, message, szArgs) =>
{
    ...
    {
        return await message.reply(" :no_entry: this parameter can't be empty you scrub :facepalm: ! Try a banner from **1** to **" + parseInt(BannersFromDatabase.length) + "**. Go here https://tutyamxx.github.io/cookie-monsta-website/banners.html to see all the available banners! :no_entry:");
    }
