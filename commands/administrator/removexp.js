...
module.exports.run = async (bot, message, szArgs) =>
{
    if(message.member.hasPermission("ADMINISTRATOR") || message.author.id === "266677298051153920")
    {
        ...
        {
            return message.reply(" :no_entry: I can only remove XP :trophy: from real people! Blame the dev LEL. :no_entry:");
        }
        ...
        const iTargetPoints = DatabaseImport.CookieMonsta_GetUserPoints(GuildGetID, GuildMember.user.id);
