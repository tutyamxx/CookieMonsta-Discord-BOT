...
module.exports.run = (bot, message, args) =>
{
    ...
    ameApi.generate("scary", { url: GetUserAvatar }).then((szImageBuffer) =>
    {
        message.channel.send(new Discord.Attachment(szImageBuffer, "scary.png")).then(() => message.channel.stopTyping(true)).catch(() => message.channel.stopTyping(true));
