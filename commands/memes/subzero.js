...
module.exports.run = (bot, message, args) =>
{
    ...
    ameApi.generate("subzero", { url: GetUserAvatar }).then((szImageBuffer) =>
    {
        message.channel.send(new Discord.Attachment(szImageBuffer, "subzero.png")).then(() => message.channel.stopTyping(true)).catch(() => message.channel.stopTyping(true));
