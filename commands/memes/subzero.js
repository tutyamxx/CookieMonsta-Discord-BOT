...
module.exports.run = async (bot, message, args) =>
{
    ...
    {
        await message.channel.send(new Discord.Attachment(szImageBuffer, "subzero.png")).then(async () => await message.channel.stopTyping(true)).catch(async () => await message.channel.stopTyping(true));
