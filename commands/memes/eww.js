...
module.exports.run = async (bot, message, args) =>
{
    ...
    .toBuffer(EwwImage, async (err, buffer) =>
    {
        ...
        await message.channel.send(new Discord.Attachment(buffer, EwwImage)).then(async () => await message.channel.stopTyping(true)).catch(async () => await message.channel.stopTyping(true));
    });
};
