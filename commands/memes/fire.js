...
module.exports.run = async (bot, message, args) =>
{
    ...
    await ameApi.generate("fire", { url: GetUserAvatar }).then(async (szImageBuffer) =>
    {
        await message.channel.send(new Discord.Attachment(szImageBuffer, "fire.png")).then(async () => await message.channel.stopTyping(true)).catch(async () => await message.channel.stopTyping(true));
