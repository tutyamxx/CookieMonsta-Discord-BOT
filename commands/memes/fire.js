...
module.exports.run = (bot, message, args) =>
{
    ...
    ameApi.generate("fire", { url: GetUserAvatar }).then((szImageBuffer) =>
    {
        message.channel.send(new Discord.Attachment(szImageBuffer, "fire.png")).then(() => message.channel.stopTyping(true)).catch(() => message.channel.stopTyping(true));
