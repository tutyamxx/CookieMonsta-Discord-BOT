...
module.exports.run = (bot, message, args) =>
{
    ...
    ameApi.generate("utatoo", { url: GetUserAvatar }).then((szImageBuffer) =>
    {
        message.channel.send(new Discord.Attachment(szImageBuffer, "ultimate_tattoo.png")).then(() => message.channel.stopTyping(true)).catch(() => message.channel.stopTyping(true));
