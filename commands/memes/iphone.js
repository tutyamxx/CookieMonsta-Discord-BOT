...
module.exports.run = (bot, message, args) =>
{
    ...
    axios.get(encodeURI("https://nekobot.xyz/api/imagegen?type=iphonex&url=") + GetUserAvatar).then((response) =>
    {
        message.channel.send(new Discord.Attachment(encodeURI(response.data.message), "iphone.png")).then(() => message.channel.stopTyping(true)).catch(() => message.channel.stopTyping(true));
